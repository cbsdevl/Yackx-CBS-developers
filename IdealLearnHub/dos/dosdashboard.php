    ...
    <div id="container">
        <div id="left-frame">
          ...
          <tr>
                    ...
                    <td><h5 style="color: black; margin-left: -170px;">View Reports</h5>
                    </a>
                </td>
                </tr>
          <tr>
...
?></h1></td>
        ...
        <tr>
        <td><h3 style="color: black;">Teacher's</h3></td>
        </tr>
        <tr>
        ...
        <tr>
        <td><h3 style="color: black;">total posts</h3></td>
        </tr>
        <tr>
        ...
        <tr>
        <td><h3 style="color: black;">Student's</h3></td>
        </tr>
        <tr>
        ...
        <div class="cont-x">
        <span><h4 id="design-x"></h4>&nbsp;</span>
        <span><h4 id="design-lin"></h4></span>
        <span><h4 class="design-l"></h4></span>
        ...
        <tr>
        <td><h2 style="color: black;">Trades</h2></td>
        </tr>
        <tr>
        ...
        <table >
        <tr>
            <td><h1 style="color: black; border: 3px solid lightseagreen; border-radius: 100%; padding: 15px; width: 80px; height: 73px;">0</h1></td>
            <td rowspan="3" class="td1">
                <svg class="icon">
        ...
        <tr>
        <td><h2 style="color: black;">Sector</h2></td>
        </tr>
        <tr>
            <td><a href="" class="view">view</a></td>
        </tr>
