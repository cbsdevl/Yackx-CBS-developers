...
do {
    if(empty($teacher_firstname) || empty($teacher_lastname) || empty($teacher_username) || empty($teacher_pass) || empty($phone)){
        $errorMessage = "All fields are required";
        break;
    }
    //add new teacher in database

$sql = "INSERT INTO teachers (teacher_firstname,teacher_lastname,teacher_username,teacher_pass,phone)" .
           "VALUES ('$teacher_firstname', '$teacher_lastname', '$teacher_username', '$teacher_pass','$phone')";
    ...
    $teacher_pass = ""; 
    $phone = "";
    $successMessage = "Teacher added corectly";
...
">Online</h6>
        ...
        <div class="design-v">
                <section class="span1">
                <h3 style="color: whitesmoke;">Add New Teacher In System</h3>
               </section>
               <br>
               <br>
               <form method="post">
               <label style="color: black;font-size: 20px;">Teacher's Firstname:</label></br>
               <input type="text" name="teacher_firstname" placeholder="Firstname" id="frm" value="<?php echo $teacher_firstname?>" required><br><br>
               <label style="color: black;font-size: 20px;">Teacher's Lastname:</label></br>
               <input type="text" name="teacher_lastname" placeholder="Lastname" id="frm" value="<?php echo $teacher_lastname?>" required><br><br>
               <label style="color: black;font-size: 20px;"> Teacher's Username:</label></br>
               <input type="text" name="teacher_username" placeholder="Username" id="frm" value="<?php echo $teacher_username?>" required><br><br>
               <label style="color: black;font-size: 20px;">Teacher's Password:</label></br>
               <input type="password" name="teacher_pass" placeholder="Password" id="frm" value="<?php echo $teacher_pass?>" required><br><br>
               <label style="color: black;font-size: 20px;">Teacher's phone:</label></br>
               <input type="number" name="phone" placeholder="phone" id="frm" value="<?php echo $phone?>" required><br><br>
               <input type="submit" value="Add" id="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="teachers.php" id="close">Close</a>
