...
">Online</h6>
        ...
        <div class="design-v">
                <section class="span1">
                <h2>
                <a class="add" href="tcreate.php">New Teacher</a>
                </h2>

                <h2 style="margin-left: -450px; margin-top: -40px;">List of Teacher's</h2></section>
                        ...
                        while($row = $result->fetch_assoc()){
                          ...
                          <td>
                          <a class='edit' href='t_edit.php?id=$row[teacher_id]'>Edit</a>&nbsp;&nbsp;
                          <a class='delete' href='tdelete.php?id=$row[teacher_id]'>Delete</a>
                          </td>
                          </tr>
                          ";
                        }
